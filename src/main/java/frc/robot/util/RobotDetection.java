...
//	private List<Pair<Pose2d, Pose2d>> estimatedRobotMotion; // Paired positional and velocity data
...
//						.map(pose -> new Pair<Pose2d, Pose2d>(pose, estimateOtherRobotVelocities().stream().map()))
