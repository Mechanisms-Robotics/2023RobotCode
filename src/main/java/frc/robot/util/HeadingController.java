...
public class HeadingController {
	...
	public HeadingController(
		...
		// We shouldn't need to use kI to stablelise the controller because it doesn't have to be
		// super
		// accurate
		...
		lockController = new PIDController(lockP, lockI, lockD, LOOP_TIME);
		inPlaceController = new PIDController(inPlaceP, inPlaceI, inPlaceD, LOOP_TIME);
