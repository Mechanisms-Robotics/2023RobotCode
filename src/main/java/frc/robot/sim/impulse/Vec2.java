...
public class Vec2 {
	...
	/**
	 * Returns the scalar cross between this vector and v. This is essentially the length of the
	 * cross product if this vector were 3d. This can also indicate which way v is facing relative
	 * to this vector.
	 */
