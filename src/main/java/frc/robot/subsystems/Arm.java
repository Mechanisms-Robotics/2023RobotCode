...
public class Arm extends SubsystemBase {
	...
	private static final double STOWED_POSITION = 1000;
	...
	public Arm() {
		...
		armMotorRight.configSupplyCurrentLimit(new SupplyCurrentLimitConfiguration(
				true,
				15.0,
				13.0,
				1.0
		...
		extenderMotor.configSupplyCurrentLimit(new SupplyCurrentLimitConfiguration(
				true,
				20.0,
				18.0,
				1.0
