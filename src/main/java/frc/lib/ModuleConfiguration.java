 ...
 *
 * <p>A configuration represents a unique mechanical configuration of a module. For example, the
 * Swerve Drive Specialties Mk3 swerve module has two configurations, standard and fast, and
...
public class ModuleConfiguration {
	 ...
	 * @param driveReduction The overall drive reduction of the module. Multiplying motor rotations
	 *     by this value should result in wheel rotations.
	 * @param driveInverted Whether the drive motor should be inverted. If there is an odd number of
	 *     gea reductions this is typically true.
	 * @param steerReduction The overall steer reduction of the module. Multiplying motor rotations
	 *     by this value should result in rotations of the steering pulley.
	 ...
	 *
	 * <p>If this value is multiplied by drive motor rotations the result would be drive wheel
	 * rotations.
	 */
	 ...
	 *
	 * <p>If this value is multiplied by steering motor rotations the result would be steering
	 * pulley rotations.
	 */
