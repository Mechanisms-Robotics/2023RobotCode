...
public class SwerveMath {
	...
	/**
	 * Calculate the angle kV which will be multiplied by the radians per second for the
	 * feedforward. Volt * seconds / degree == (maxVolts) / (maxSpeed)
	 *
	 ...
	 * @param angleGearRatio Angle gear ratio, the amount of times the motor as to turn for the
	 *     wheel rotation.
	...
	/**
	 * Calculate the meters per rotation for the integrated encoder. Calculation: 4in diameter
	 * wheels * pi [circumfrence] / gear ratio.
	 *
	...
	/**
	 * Calculates the maximum acceleration allowed in a direction without tipping the robot. Reads
	 * arm position from NetworkTables and is passed the direction in question.
	 *
	...
	private static double calcMaxAccel(
		...
		// Calculate the vertical mass moment using the floor as the datum.  This will be used later
		// to
	...
	public static Translation2d limitVelocity(
		...
		Translation2d maxAccel =
				new Translation2d(
						calcMaxAccel(
								deltaV
										// Rotates the velocity vector to convert from
