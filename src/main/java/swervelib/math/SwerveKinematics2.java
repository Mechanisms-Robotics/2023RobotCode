 ...
 * states from chassis speed. Makes use of {@link SwerveModuleState2} to add the angular velocity
...
public class SwerveKinematics2 extends SwerveDriveKinematics {
	...
	public static void desaturateWheelSpeeds(
		...
		double translationalK =
				Math.hypot(
								currentChassisSpeed.vxMetersPerSecond,
								currentChassisSpeed.vyMetersPerSecond)
	 ...
	 *     the attainable max velocity. Use the {@link #desaturateWheelSpeeds(SwerveModuleState2[],
	...
	public SwerveModuleState2[] toSwerveModuleStates(
		...
		accelerationVector.setColumn(
				0, 0, 0, 0, Math.pow(chassisSpeeds.omegaRadiansPerSecond, 2), 0);
