...
public class SwerveParser {
	...
	public SwerveParser(File directory) throws IOException {
		...
		controllerPropertiesJson =
				new ObjectMapper()
						.readValue(
								new File(directory, "controllerproperties.json"),
								ControllerPropertiesJson.class);
		pidfPropertiesJson =
				new ObjectMapper()
						.readValue(
								new File(directory, "modules/pidfproperties.json"),
	...
	private void checkDirectory(File directory) {
		...
		assert new File(directory, "modules").exists()
				&& new File(directory, "modules").isDirectory();
