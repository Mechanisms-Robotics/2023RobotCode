...
public class SwerveModulePhysicalCharacteristics {
	...
	/**
	 * Drive gear ratio. How many times the motor has to spin before the wheel makes a complete
	 * rotation.
	 */
	public final double driveGearRatio;
	/**
	 * Angle gear ratio. How many times the motor has to spin before the wheel makes a full
	 * rotation.
	 */
	 ...
	 * @param driveEncoderPulsePerRotation The number of encoder pulses per motor rotation, 1 for
	 *     integrated encoders.
	 ...
	 * (taken from blue nitrile on carpet from Studica) and optimal voltage is 12v. Assumes the
	 * drive motor current limit is 40A, and the angle motor current limit is 20A.
	 *
	 * @param driveGearRatio Gear ratio of the drive motor. Number of motor rotations to rotate the
	 *     wheel.
	 * @param angleGearRatio Gear ratio of the angle motor. Number of motor rotations to spin the
