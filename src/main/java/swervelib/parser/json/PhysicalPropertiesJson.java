...
public class PhysicalPropertiesJson {
	...
	/**
	 * Gear ratio for the motors, number of times the motor has to spin before the wheel rotates a
	 * single time.
	 */
	 ...
	 *
	 * @param optimalVoltage Optimal voltage to compensate for and use to calculate drive motor
	 *     feedforward.
