...
public class SwerveController {
	...
	/**
	 * {@link SwerveControllerConfiguration} object storing data to generate the {@link
	 * PIDController} for controlling the robot heading, and deadband for heading joystick.
	 */
	 ...
	 *
	 * @param cfg {@link SwerveControllerConfiguration} containing the PIDF variables for the
	 *     heading PIDF.
	 */
	...
	public ChassisSpeeds getTargetSpeeds(
		...
		// Convert joystick inputs to m/s by scaling by max linear speed.  Also uses a cubic
		// function
	...
	public ChassisSpeeds getTargetSpeeds(
		...
		// Converts the horizontal and vertical components to the commanded angle, in radians,
		// unless
		...
		double angle =
				withinHypotDeadband(headingX, headingY)
						? lastAngleScalar
