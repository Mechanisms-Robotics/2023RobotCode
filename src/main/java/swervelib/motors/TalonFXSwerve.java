...
public class TalonFXSwerve extends SwerveMotor {
	...
	/**
	 * Put an angle within the the 360 deg scope of a reference. For example, given a scope
	 * reference of 756 degrees, assumes the full scope is (720-1080), and places an angle of 22
	 * degrees into it, returning 742 deg.
	 *
	...
	public void setPosition(double position) {
		if (!absoluteEncoder && !SwerveDriveTelemetry.isSimulation) {
			position =
					position < 0 ? (position % 360) + 360 : position; // Fixes initial 360 movement.
