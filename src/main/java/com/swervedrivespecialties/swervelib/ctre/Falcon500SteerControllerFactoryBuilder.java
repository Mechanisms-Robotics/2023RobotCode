...
public final class Falcon500SteerControllerFactoryBuilder {
	...
	private class FactoryImplementation<T>
		...
		public ControllerImplementation create(
				SteerConfiguration<T> steerConfiguration,
				String canbus,
			...
			final double sensorPositionCoefficient =
					2.0 * Math.PI / TICKS_PER_ROTATION * mechConfiguration.getSteerReduction();
			...
			motor.setInverted(
					mechConfiguration.isSteerInverted()
	...
	private static class ControllerImplementation implements SteerController {
		...
		@Override
		public void reset() {
			resetIteration = ENCODER_RESET_ITERATIONS;
		}
